...
#     # Get chat by JID
#     direct_chat = get_direct_chat_by_contact("447341159258")
#     if direct_chat is None:
#         print("No direct chat found")
#         exit()
#     chat = get_chat(direct_chat.jid)
#     print(chat)

#     # Get messages from chat
#     messages = list_messages(chat_jid=direct_chat.jid)
#     print(messages)
    
#     # Send a message
#     success, message = send_message("447341159258", "Hello from Python!")
#     print(f"Message sent: {success}, Status: {message}")
